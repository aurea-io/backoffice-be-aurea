...
async function main() {
  ...
  const canonicalCatalog = [
    // Core
    { key: 'core.dashboard', kind: 'module', sectionKey: 'core', pageKey: 'dashboard', moduleKey: 'dashboard', label: 'Resumen', permissions: [], metadata: { path: '/dashboard', sectionName: 'Principal' } },
    ...
    { key: 'core.members', kind: 'module', sectionKey: 'core', pageKey: 'members', moduleKey: 'members', label: 'Equipo', permissions: ['tenant:employees:read'], metadata: { path: '/members', sectionName: 'Principal' } },
    ...
    { key: 'core.theme', kind: 'module', sectionKey: 'core', pageKey: 'theme', moduleKey: 'theme', label: 'Configuración', permissions: [], metadata: { path: '/settings', sectionName: 'Principal' } },
    ...
    { key: 'core.billing', kind: 'module', sectionKey: 'core', pageKey: 'billing', moduleKey: 'billing', label: 'Plan y Facturación', permissions: [], metadata: { path: '/settings/billing', sectionName: 'Principal' } },
    ...
    // Services
    { key: 'services.bookings', kind: 'module', sectionKey: 'services', pageKey: 'bookings', moduleKey: 'bookings', label: 'Agenda de Turnos', permissions: ['appointments:read', 'bookings.view'], metadata: { path: '/appointments', feature: 'bookings', sectionName: 'Servicios' } },
    ...
    // Commerce
    { key: 'commerce.catalog', kind: 'module', sectionKey: 'commerce', pageKey: 'catalog', moduleKey: 'catalog', label: 'Catálogo', permissions: ['catalog:read', 'catalog.view', 'catalog:write'], metadata: { path: '/catalog', feature: 'catalog', sectionName: 'Comercio' } },
    ...
    { key: 'commerce.inventory', kind: 'module', sectionKey: 'commerce', pageKey: 'inventory', moduleKey: 'inventory', label: 'Inventario', permissions: ['inventory:read', 'inventory.manage'], metadata: { path: '/inventory', feature: 'inventory', sectionName: 'Comercio' } },
    ...
    { key: 'commerce.pos', kind: 'module', sectionKey: 'commerce', pageKey: 'pos', moduleKey: 'pos', label: 'Caja & Cobros', permissions: ['pos.cashier', 'pos:read'], metadata: { path: '/pos', feature: 'pos_cashier', sectionName: 'Comercio' } },
    ...
    // Gastronomy
    { key: 'gastronomy.tables', kind: 'module', sectionKey: 'gastronomy', pageKey: 'tables', moduleKey: 'tables', label: 'Salón y Mesas', permissions: ['tables.view', 'tables:read', 'orders:create'], metadata: { path: '/restaurant', feature: 'tables', sectionName: 'Gastronomía' } },
    ...
    { key: 'gastronomy.table-bookings', kind: 'module', sectionKey: 'gastronomy', pageKey: 'table-bookings', moduleKey: 'table-bookings', label: 'Reservas de Salón', permissions: ['tables.view', 'bookings.view'], metadata: { path: '/table-bookings', feature: 'tables', sectionName: 'Gastronomía' } },
    ...
    { key: 'gastronomy.kitchen', kind: 'module', sectionKey: 'gastronomy', pageKey: 'kitchen', moduleKey: 'kitchen', label: 'Cocina / KDS', permissions: ['kitchen.view', 'kitchen:read'], metadata: { path: '/kitchen', feature: 'kitchen', sectionName: 'Gastronomía' } },
    ...
    // CRM
    { key: 'crm.clients', kind: 'module', sectionKey: 'crm', pageKey: 'clients', moduleKey: 'clients', label: 'Clientes', permissions: ['clients:read', 'clients.view'], metadata: { path: '/clients', feature: 'clients', sectionName: 'Gestión de Clientes' } },
    ...
    // Marketing
    { key: 'marketing.coupons', kind: 'module', sectionKey: 'marketing', pageKey: 'coupons', moduleKey: 'coupons', label: 'Cupones', permissions: ['marketing:read'], metadata: { path: '/coupons', feature: 'marketing', sectionName: 'Marketing & Lealtad' } },
    ...
    { key: 'marketing.loyalty', kind: 'module', sectionKey: 'marketing', pageKey: 'loyalty', moduleKey: 'loyalty', label: 'Fidelización', permissions: ['marketing:read'], metadata: { path: '/loyalty', feature: 'marketing', sectionName: 'Marketing & Lealtad' } },
