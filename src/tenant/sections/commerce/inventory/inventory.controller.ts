...
export class InventoryController {
  ...
  list(@CurrentTenant() tenant: TenantContext) {
    return this.inventoryService.list(tenant.tenantId);
  }
  ...
  create(
    ...
    return this.inventoryService.create(tenant.tenantId, dto);
  }
  ...
  adjust(
    ...
    return this.inventoryService.adjust(tenant.tenantId, id, dto);
  }
}
